...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_all(
		...
		KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, TG(4) , KC_TRNS, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS, KC_TRNS, 
		KC_LSFT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, TG(3), KC_TRNS, KC_VOLD, KC_VOLU, KC_MPLY, KC_INSERT, KC_PGUP, KC_TRNS,
		KC_LCTL, KC_LGUI, M(1), KC_DEL, KC_TRNS, KC_BSPC, KC_DEL, M(0), KC_TRNS, KC_PGDOWN, KC_TRNS),

	[3] = LAYOUT_all(
		M(3), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_7, KC_8, KC_9, KC_SLSH, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
...
qk_tap_dance_action_t tap_dance_actions[] = {
	...
	// [TD_H] = ACTION_TAP_DANCE_DOUBLE(KC_H, KC_HOME),
	// [TD_E] = ACTION_TAP_DANCE_DOUBLE(KC_E, KC_END)
